...
export class SchemaEditorComponent implements OnInit, OnDestroy {
  ...
  viewFullSchema() {
    ...
    const line = this.findCurrentLineNumbers(this.editor.getEditor(), schema.label);
    ...
    if (this.viewingUncompiled) {
      ...
      this.editor.getEditor().scrollToLine(0);
       ...
       this.setCompiledTheme(); this.editor.setText(this._schema); this.editor.getEditor().scrollToLine(0);
    }
