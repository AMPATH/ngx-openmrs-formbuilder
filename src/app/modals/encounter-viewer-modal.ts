  ...
  template: `<div class="modal-dialog modal-lg">
                <div class="modal-content">
                   ...
                   <div class="modal-body" *ngIf="form&&encounter">
                     <encounter-renderer [form]="form" [encounter]="encounter"></encounter-renderer>
                   </div>
...
export class EncounterViewerModalComponent extends DialogComponent<EncounterViewerModel, null> implements EncounterViewerModel, OnInit {
  form: any;
  encounter: any;
